...
int main (int argc, char **argv)
{
	...
	if (execBasePtr->AttnFlags & AFF_68060)
		printf(" 68060 ");
	else if (execBasePtr->AttnFlags & AFF_68040)
		printf(" 68040 ");
	else if (execBasePtr->AttnFlags & AFF_68030)
		printf(" 68030 ");
	else if (execBasePtr->AttnFlags & AFF_68020)
		printf(" 68020 ");
	else if (execBasePtr->AttnFlags & AFF_68010)
		printf(" 68010 ");
	else
		printf(" 68000 ");
	...
	if (execBasePtr->AttnFlags & AFF_FPU40)
	{
		...
		if (execBasePtr->AttnFlags & AFF_68882 OR execBasePtr->AttnFlags & AFF_68881)
			printf("& Mlib ");
		else
			printf("/ Std. ");
	}
	else
	{
		if (execBasePtr->AttnFlags & AFF_68882)
			printf("68882       ");
		else if (execBasePtr->AttnFlags & AFF_68881)
			printf("68881      ");
		else
				printf("N/A        ");
	}
...
/* END CPU
   BEGIN EXECBASE */
	...
	if (KickVersion()==2037)
	{
		...
		if (ret)
			printf("ERROR: Patch schlug fehl!\n");
		else
		{
			printf("OK! Gegentest: ");
...
--1463p4TteRSuKXBIgGr8gRiNDIkkZAlLD3I
